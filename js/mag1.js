...
var zoom_areaa_size = 100;
var zoom_radius = zoom_areaa_size / 2;
...
$( '.thumbnail' ).mousemove(function(e) {
    ...
    // Ratios
    var ratioX = ( $original.width() - zoom_container_size) / ( $( this ).width() - zoom_areaa_size );
    var ratioY = ( $original.height() - zoom_container_size) / ( $( this ).height() - zoom_areaa_size );
